"""Ld Coordinator agent -- LangGraph implementation."""
...
DEFAULT_TOOLS = ['search_content_fulltext', 'create_page', 'get_employee', 'schedule_interview']
...
def load_prompt(variables: dict[str, str] | None = None) -> str:
    ...
    path = os.path.join(PROMPTS_DIR, "ld_coordinator.prompt.txt")
