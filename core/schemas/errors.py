...
ERROR_META: dict[str, dict] = {
    ...
    "E3003": {
        "name": "WORKFLOW_INVALID",
        "severity": "critical",
        "retryable": False,
        "escalate_after_retries": True,
    },
    "E3004": {
        "name": "STEP_DEPENDENCY_UNRESOLVED",
        "severity": "error",
        "retryable": False,
        "escalate_after_retries": True,
    },
    ...
    "E5005": {
        "name": "LLM_HALLUCINATION_DETECTED",
        "severity": "critical",
        "retryable": False,
        "escalate_after_retries": True,
    },
