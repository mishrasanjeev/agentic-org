...
CONNECTORS = [
    # HR
    (
        "connectors/hr/darwinbox.py",
        "darwinbox",
        "hr",
        "api_key_oauth2",
        "https://org.darwinbox.in/api",
        200,
        [
            "get_employee",
            "create_employee",
    ...
    (
        "connectors/hr/keka.py",
        "keka",
        "hr",
        "api_key",
        "https://api.keka.com/v1",
        100,
        [
            "get_employee",
            "run_payroll",
    ...
    (
        "connectors/hr/linkedin_talent.py",
        "linkedin_talent",
        "hr",
        "oauth2",
    ...
    (
        "connectors/hr/epfo.py",
        "epfo",
        "hr",
        "dsc",
        "https://unifiedportal-emp.epfindia.gov.in/api",
        10,
        [
            "file_ecr",
            "get_uan",
    ...
    (
        ...
        [
            ...
            "void_envelope",
            "get_status",
            "extract_completed_fields",
            "download_signed_doc",
            "create_template",
        ],
    ),
    (
        "connectors/hr/zoom.py",
        "zoom",
        "hr",
        "oauth2",
    ...
    # Finance
    (
        "connectors/finance/oracle_fusion.py",
        "oracle_fusion",
        "finance",
        "rest_soap",
        "https://org.oraclecloud.com/fscmRestApi/resources",
        500,
        [
            "post_journal_entry",
            "get_gl_balance",
    ...
    (
        "connectors/finance/sap.py",
        "sap",
        "finance",
        "odata_oauth2",
        "https://org.s4hana.cloud/sap/opu/odata/sap",
        300,
        [
            "post_fi_document",
            "get_account_balance",
    ...
    (
        "connectors/finance/banking_aa.py",
        "banking_aa",
        "finance",
        "aa_oauth2",
        "https://aa.finvu.in/api/v1",
        100,
        [
    ...
    (
        "connectors/finance/pinelabs_plural.py",
        "pinelabs_plural",
        "finance",
        "api_key",
    ...
    (
        ...
        [
            ...
            "get_ledger_balance",
            "generate_gst_report",
            "export_tally_xml_data",
            "get_trial_balance",
            "get_stock_summary",
        ],
    ),
    (
        "connectors/finance/income_tax_india.py",
        "income_tax_india",
        "finance",
        "dsc",
        "https://www.incometax.gov.in/iec/foportal/api",
        10,
        [
            "file_26q_return",
            "file_24q_return",
    ...
    (
        ...
        "ops",
        "oauth2",
        "https://org.atlassian.net/rest/api/3",
        300,
        [
            "create_issue",
            "update_issue",
    ...
    (
        "connectors/ops/confluence.py",
        "confluence",
        "ops",
        "oauth2",
        "https://org.atlassian.net/wiki/rest/api",
        200,
        [
            "create_page",
            "update_page_content",
    ...
    (
        "connectors/ops/zendesk.py",
        "zendesk",
        "ops",
        "api_token",
        "https://org.zendesk.com/api/v2",
        200,
        [
            "create_ticket",
            "update_ticket",
    ...
    (
        "connectors/ops/servicenow.py",
        "servicenow",
        "ops",
        "rest_oauth2",
        "https://org.service-now.com/api/now",
        100,
        [
            "create_incident",
            ...
            "update_cmdb_ci",
            "check_sla_status",
            "fulfil_service_catalog_request",
            "get_kb_article",
        ],
    ),
    (
        "connectors/ops/pagerduty.py",
        "pagerduty",
        "ops",
        "api_key",
    ...
    (
        "connectors/ops/mca_portal.py",
        "mca_portal",
        "ops",
        "dsc",
        "https://www.mca.gov.in/mcafoportal/api",
        10,
        [
            "file_annual_return",
            "complete_director_kyc",
            "fetch_company_master_data",
    ...
    (
        ...
        "marketing",
        "oauth2_soap",
        "https://org.my.salesforce.com/services/data/v60.0",
        300,
        [
            "create_lead",
    ...
    (
        ...
        [
            ...
            "pause_underperforming_adset",
            "create_remarketing_audience",
            "get_search_term_report",
        ],
    ),
    (
        "connectors/marketing/meta_ads.py",
        "meta_ads",
        "marketing",
        "oauth2",
    ...
    (
        "connectors/marketing/linkedin_ads.py",
        "linkedin_ads",
        "marketing",
        "oauth2",
        "https://api.linkedin.com/v2",
        100,
        [
            "create_sponsored_content_campaign",
            "get_campaign_impressions",
            "create_lead_gen_form",
            "define_account_audience_targeting",
        ],
    ),
    (
        "connectors/marketing/ahrefs.py",
        "ahrefs",
        "marketing",
        "api_token",
        ...
        [
            ...
            "identify_content_gaps_vs_competitor",
    ...
    (
        "connectors/marketing/mixpanel.py",
        "mixpanel",
        "marketing",
        "api_key",
        ...
        100,
        [
            "get_funnel_conversion_data",
            "get_retention_cohort",
            "query_event_data",
            "create_user_cohort",
            "export_raw_event_data",
        ],
    ),
    (
        "connectors/marketing/buffer.py",
        "buffer",
        "marketing",
        "oauth2",
    ...
    (
        "connectors/marketing/brandwatch.py",
        "brandwatch",
        "marketing",
        "oauth2",
        ...
        [
            ...
            "get_share_of_voice",
            "set_volume_spike_alert",
            "export_mention_report",
        ],
    ),
    # Comms
    (
        ...
        [
            ...
            "upload_file",
            "set_channel_reminder",
            "search_message_history",
        ],
    ),
    (
        "connectors/comms/sendgrid.py",
        "sendgrid",
        "comms",
        "api_key",
    ...
    (
        ...
        [
            ...
            "trigger_tts_call_with_script",
        ],
    ),
    (
        "connectors/comms/whatsapp.py",
        "whatsapp",
        "comms",
        "meta_business",
        "https://graph.facebook.com/v21.0",
        100,
        [
            "send_approved_template_message",
    ...
    (
        "connectors/comms/google_calendar.py",
        "google_calendar",
        "comms",
        "oauth2",
    ...
    (
        "connectors/comms/github_connector.py",
        "github",
        "comms",
        "pat_oauth2",
        ...
        [
            ...
            "trigger_github_action_workflow",
            "get_repository_statistics",
            "create_release",
        ],
    ),
    (
        "connectors/comms/langsmith_connector.py",
        "langsmith",
        "comms",
        "api_key",
