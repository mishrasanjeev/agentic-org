...
results.append(("API: 51 connectors", h.get("checks", {}).get("connectors", {}).get("registered") == 43))
...
results.append(("A2A: 35 agents in desc", "35 agents" in c.get("description", "")))
results.append(("A2A: 51 connectors in desc", "51 connectors" in c.get("description", "")))
results.append(("A2A: 320+ tools in desc", "320+ tools" in c.get("description", "")))
...
results.append(("SEO: llms.txt 35 agents", "25 pre-built" in r.text or "35 agents" in r.text))
results.append(("SEO: llms.txt 51 connectors", "43" in r.text))
results.append(("SEO: llms.txt 320+ tools", "273" in r.text))
