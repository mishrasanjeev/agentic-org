...
results.append(("A2A: 50+ agents in desc", "50+ agents" in c.get("description", "")))
results.append(("A2A: 54 connectors in desc", "54 connectors" in c.get("description", "")))
results.append(("A2A: 340+ tools in desc", "340+ tools" in c.get("description", "")))
...
results.append(("SEO: llms.txt 50+ agents", "50+ pre-built" in r.text or "50+ agents" in r.text))
results.append(("SEO: llms.txt 54 connectors", "54" in r.text))
results.append(("SEO: llms.txt 340+ tools", "340+" in r.text))
