...
export const CONTENT_PAGES: ContentPage[] = [
  {
    ...
    heroStat: { value: "0", label: "Payment success claims from cache" },
    sections: [
      { heading: "Merchant Flow", body: "A merchant starts in AgenticOrg by creating a Seller Commerce Agent, connecting Shopify with read-only credential custody, running source sync, and requesting Grantex OACP authority artifacts. Shopify remains the source of record." },
      { heading: "Requirements", body: "You need a public myshopify.com domain, read-only Admin API or approved OAuth access, an AgenticOrg tenant, Grantex tenant allowlisting, channel approvals, and provider capability configuration if purchase handoff is offered." },
    ...
    faqs: [
      ...
      { q: "Can the buyer agent complete payment by itself?", a: "No. Payment and mandate rails remain provider-owned and require separate approval." },
    ],
  ...
  },
  {
    ...
    sections: [
      { heading: "Provider Boundary", body: "Pine Labs Plural/P3P owns mandate and payment rail execution. AgenticOrg verifies capability metadata and stores redacted evidence refs." },
    ...
    faqs: [
      ...
      { q: "Where does payment success come from?", a: "Only from approved provider and merchant systems." },
    ],
  ...
  },
  {
    ...
    sections: [
      { heading: "Launch Smoke", body: "Create onboarding packet, store Shopify credentials, run read-only sync, request Grantex authority, cache artifacts, ask buyer question, check bridge matrix, verify Plural/Pine capability, and prepare purchase handoff." },
  ...
  },
  {
    ...
    metaDescription: "How AgenticOrg's Commerce Sales Agent uses Grantex-only commerce tools, OACP artifact cache controls, consent, Commerce Passports, and provider-neutral checkout handoff.",
  ...
  },
  {
    ...
    faqs: [
      { q: "What is AgenticOrg's SOC-2 status?", a: "AgenticOrg has SOC-2 controls implemented and documented. Formal audit work is in progress, and evidence packages are exportable." },
    ],
