...
export const CONTENT_PAGES: ContentPage[] = [
  ...
  },
  {
    ...
    sections: [
      ...
      { heading: "AgenticOrg vs Alternatives", body: "AgenticOrg provides 25 pre-built agents that call real APIs (Jira, HubSpot, GitHub), 43 enterprise connectors (273 tools), no-code agent builder, HITL governance, shadow mode, and India-first compliance — all deployable in under 5 minutes on any Kubernetes cluster." },
    ],
    faqs: [
