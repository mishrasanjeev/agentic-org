...
export const CONTENT_PAGES: ContentPage[] = [
  {
    ...
    sections: [
      ...
      { heading: "Latest OACP Cache Foundation", body: "AgenticOrg now has an internal durable OACP artifact cache foundation and a local maintenance planner. Cache records are scoped by buyer agent, seller agent, tenant, and merchant and are evaluated for TTL, freshness, revocation posture, source refs, risk tier, and non-execution flags.\n\nThe maintenance planner can recommend keep, refresh, evict, purge, quarantine, source-refresh, or human-review outcomes. It does not refresh records, schedule jobs, call Grantex live, call providers, call merchant private APIs, execute checkout, or create payments." },
