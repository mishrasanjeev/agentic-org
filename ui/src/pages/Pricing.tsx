...
const FAQS = [
  ...
  },
  {
    ...
    a: "Free includes 20 core connectors (Oracle, SAP, Salesforce, Slack, GSTN, and more). Pro and Enterprise include all 51 connectors (Darwinbox, Stripe, HubSpot, EPFO, Jira, and more). Enterprise adds custom integrations.",
  },
  {
    q: "Is my data secure?",
      ...
      <section className="pt-32 pb-16 px-4 bg-gradient-to-b from-slate-900 via-slate-800 to-white">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <p className="text-lg text-slate-300 max-w-2xl mx-auto">
            Start free with 35 agents. Scale to unlimited agents and 51 connectors as your team grows.
      ...
      <section className="py-20 px-4 bg-gradient-to-r from-slate-900 to-slate-800">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <p className="text-slate-300 mb-8 max-w-xl mx-auto">
            Start free with 35 agents and 20 connectors. Upgrade to Pro for 51 connectors and unlimited tasks.
          </p>
