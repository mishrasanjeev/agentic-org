...
| INT-CONN-011 | Not generic for custom connectors | Inherent limitation — all 54 connectors are registered imports. Custom connector API would need a plugin system (future roadmap). Documented as known limitation. | N/A |
...
| `tests/connector_harness/test_all_connectors.py` | pytest harness | Updated | CONN-012 (54 connectors) |
