...
| Missing | Broad order/payment/mandate/POS execution, universal buyer-surface rollout, multi-merchant self-service launch, external public protocol approval. | Track as pending runtime/product gaps. |
