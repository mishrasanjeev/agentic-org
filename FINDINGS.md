...
## A-14 — Chat-created approvals cannot resume their run
...
## A-15 — No automatic retention for the Postgres checkpoint store
...
## A-16 — A refused, failed or interrupted approval resume cannot be retried
