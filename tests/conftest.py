...
# A-58) burns down, a new violation fails immediately. One logical violation
# trips the guard once on the shared engine and twice where `pool_pre_ping` is
# off, so this is a reproducible number rather than a count of mistakes.
